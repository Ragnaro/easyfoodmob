...
<body id="page-top" data-spy="scroll" data-target=".navbar-fixed-top" style="background:#fff">
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse navbar-right navbar-main-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li class="hidden">
                        <a id="msnerror" href="#page-top"></a>
                    </li>
                    <li>
                        <a id="msnerror" class="page-scroll" href="#about">Explicacion</a>
                    </li>
                    <!--li>
